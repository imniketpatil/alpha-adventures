...
function TrekSliderForDifficulty() {
  ...
  const settings =
    trekDifficultyList.length === 1 ? singleSlideSettings : defaultSettings;
  ...
  return (
    <div className="w-full">
      <div className="w-[98%] m-auto">
        {trekDifficultyList.length === 0 ? (
          <p>No treks available at the moment.</p>
        ) : (
          <Slider {...settings}>
            {trekDifficultyList.map((trek, index) => (
              <div
                key={index}
